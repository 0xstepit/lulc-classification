...
# Also:
#
# DJF (winter): rainfall drives a flush of growth — natural vegetation, pasture, and especially winter cereals (wheat, barley) are actively growing and green.
# JJA (summer): near-zero rainfall, high heat → natural vegetation and rain-fed crops senesce/dry out (hence the deep red in the southern half of your images, which is dry farmland). Only irrigated crops (cotton, sunflowers, orchards near the river) stay green in summer — and if you look closely, you can actually see this in your JJA panel: there are small dark-green rectangular patches (irrigated fields) that are notably absent or less distinct in DJF.
