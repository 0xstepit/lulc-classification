...
# # Crop and Resampling
#
# In this notebook, we are going to investigate how to use `rasterio` to load a cropped and resized area of interest (AoI) out of a raster.
...
# %% [markdown]
# This scene has been obtained by using this bounding box in the filter:
...
# %% [markdown]
# Since the coordinates of our AoI are higher than the ones of the tile for the west-south, and lower for the east-north, our AoI is fully contained in the tile.
