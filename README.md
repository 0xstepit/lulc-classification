...
End-to-end land use/land cover classification pipeline using Sentinel-2
satellite imagery and U-net deep learning model.

Learn the spectro-temporal pattern
